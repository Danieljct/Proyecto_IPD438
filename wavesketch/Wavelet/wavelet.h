...
public:
    ...
    void set_min() const {
        ...
        // =======================================================
        // SOLUCIÓN: Añadir esta comprobación
        // =======================================================
        if (result.empty()) {
            // Si el vector está vacío, no podemos calcular 't' ni 'm'.
            // Debes decidir qué hacer aquí.
            // Opción 1: Simplemente salir.
            return;

            // Opción 2: Asignar valores por defecto a thresh_hi y thresh_lo
            // pseudo_heap<...>::thresh_hi = VALOR_POR_DEFECTO;
            // pseudo_heap<...>::thresh_lo = VALOR_POR_DEFECTO;
            // return;
        }
        // =======================================================
